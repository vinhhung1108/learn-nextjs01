...
export default function DetailPostPage ( { post }: DetailPostPageProps) { // same with "props: DetailPostPageProps"
...
export const getStaticProps: GetStaticProps<DetailPostPageProps> = async(context: GetStaticPropsContext) => {
